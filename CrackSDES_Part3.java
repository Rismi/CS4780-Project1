public class CrackSDES_Part3 {
    public static void main(String[] args) {
        ...
        // convert cascii bits to string for output
        ...
        // decrypt the ciphertext for each possible 10 bit key and convert the decrypted
        // string to ascii
        for (int i = 0; i < 1024; i++) {
            plaintext1 = SDES_Part1.Decrypt(key1, ciphertext1);
            String s = CASCII.toString(plaintext1);
            // check if the decrypted string has valid punctuation, may need more checks if
            // this does not find the message
    ...
    // check if punctuation is placed properly and followed by a space
